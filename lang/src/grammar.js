...
function peg$parse(input, options) {
  ...
  var peg$f83 = function(exprs) { return exprs.reduce(Serif.MapExpression); };
  ...
  var peg$f98 = function(callee, args) { return args.reduce((callee, arg) => Serif.Application(callee, [arg]), callee); };
