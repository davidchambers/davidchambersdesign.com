...
import {ArrayExpression, ArrowFunctionExpression, BooleanLiteral, CallExpression, ConditionalExpression, Identifier, InfixExpression, MemberExpression, NullLiteral, NumberLiteral, ObjectExpression, PrefixExpression, SpreadElement, StringLiteral, SwitchCase, SwitchExpression} from "./Node.js";
const id = x => x;
const compose = f => g => (() => {
...
const member$0027 = compose($lhs => compose($lhs)(string))(member);
const prefix = PrefixExpression;
const infix = InfixExpression;
const lambda = flip(reduceRight(flip(compose(ArrowFunctionExpression)(Array.of))));
const apply = reduce(compose($lhs => compose($lhs)(Array.of))(CallExpression));
...
const $0023y = ident("y");
const _typeof_ = prefix("typeof");
const _$0021_ = prefix("!");
const _$002F_ = infix("/");
const _$0025_ = infix("%");
const _$002B_ = infix("+");
const _$002D_ = infix("-");
const _instanceof_ = infix("instanceof");
const _$003D$003D$003D_ = infix("===");
const _$0026_ = infix("&");
const _$005E_ = infix("^");
const _$007C_ = infix("|");
const _$0026$0026_ = infix("&&");
const _$007C$007C_ = infix("||");
const $construct = curry2(invoke($0023globalThis)(["Reflect", "construct"]));
const Set = compose($construct(member$0027($0023globalThis)("Set")))(compose(array)(Array.of));
const Map = compose($construct(member$0027($0023globalThis)("Map")))(compose(array)(Array.of));
const cond = predicate => consequent => alternative => ConditionalExpression(predicate)(consequent)(Just(alternative));
const defineSwitch = discriminant => transform => default$ => compose(SwitchExpression(discriminant))(compose(append(SwitchCase([Nothing])(default$)))(compose(map(([names, expr]) => SwitchCase(map(compose(Just)(compose(string)(transform)))((args => target => target.split.apply(target, args))(["/"])(names)))(expr)))(Object.entries)));
