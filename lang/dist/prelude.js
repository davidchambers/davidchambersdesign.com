...
const Prelude = {
  XOR: ArrowFunctionExpression([$0023rhs])(ArrowFunctionExpression([$0023lhs])(SwitchExpression(Object$0023toString($0023rhs))([SwitchCase([Just(StringLiteral("[object Set]"))])(CallExpression(MemberExpression($0023Reflect)($0027construct))([$0023Set, ArrayExpression([CallExpression(MemberExpression(ArrayExpression([SpreadElement($0023lhs)]))($0027filter))([ArrowFunctionExpression([$0023x])(CallExpression(MemberExpression($0023rhs)($0027has))([$0023x]))])])])), SwitchCase([Nothing])(BinaryExpression("^")($0023lhs)($0023rhs))]))),
