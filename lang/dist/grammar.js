...
function peg$parse(input, options) {
  ...
  var peg$f51 = function(ident) { return {type: 'MethodCallExpression', name: ident.name}; };
  var peg$f52 = function(expression) { return expression; };
  var peg$f53 = function(source) { return {type: 'ImportExpression', source}; };
  var peg$f54 = function(head, arg) { return callee => ({type: 'CallExpression', callee, arguments: [arg]}); };
  var peg$f55 = function(head, ident) { return object => ({type: 'MemberExpression', object, property: {type: 'StringLiteral', value: ident.name}}); };
  var peg$f56 = function(head, property) { return object => ({type: 'MemberExpression', object, property}); };
  ...
  var peg$f61 = function() { return {type: 'ArrayPattern', elements: []}; };
  var peg$f62 = function(elisions) { return {type: 'ArrayPattern', elements: elisions}; };
  var peg$f63 = function(elision) { return elision; };
  var peg$f64 = function(element) { return element; };
  var peg$f65 = function(elements, element) { return {type: 'ArrayPattern', elements: element == null ? elements : [...elements, element]}; };
  var peg$f66 = function() { return {type: 'Elision'}; };
  var peg$f67 = function() { return {type: 'ObjectPattern', properties: []}; };
  var peg$f68 = function(properties) { return {type: 'ObjectPattern', properties}; };
  var peg$f69 = function(ident, pattern) { return {type: 'Property', key: {type: 'StringLiteral', value: ident.name}, value: pattern}; };
  var peg$f70 = function(ident) { return {type: 'Property', key: {type: 'StringLiteral', value: ident.name}, value: ident}; };
  var peg$f71 = function(argument) { return {type: 'RestElement', argument}; };
  var peg$f72 = function(operator, argument) { return {type: 'UnaryExpression', operator, argument}; };
  var peg$f73 = function(exprs) { return exprs.reduceRight((right, left) => ({type: 'CompositionExpression', left, right})); };
  ...
  var peg$f79 = function(left, tail) { return tail.reduce((left, {operator, right}) => ({type: 'BinaryExpression', operator, left, right}), left); };
  var peg$f80 = function(exprs) { return exprs.reduceRight((right, left) => ({type: 'ConcatenationExpression', left, right})); };
  ...
  var peg$f110 = function(operation) { return operation; };
  var peg$f111 = function(operations, result) { return {type: 'DoBlockExpression', operations, result}; };
  var peg$f112 = function(pattern, expression) { return {type: 'ArrowAssignmentStatement', pattern, expression}; };
  var peg$f113 = function(ident, parameter) { return parameter; };
  var peg$f114 = function(ident, parameters, body) { return {type: 'FunctionDeclaration', name: ident.name, parameters, body}; };
  var peg$f115 = function(pattern, expression) { return {type: 'VariableDeclaration', pattern, expression}; };
  var peg$f116 = function(expression) { return {type: 'ExpressionStatement', expression}; };
  var peg$f117 = function(argument) { return {type: 'SpreadElement', argument}; };
  var peg$currPos = 0;
  var peg$savedPos = 0;
