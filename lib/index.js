  ...
  foldMap (String)
          (node => {
             ...
             const attrs = pipe ([
               ...
               map (k => [(String (k)).slice ('Symbol('.length, -')'.length), rawAttrs[k]]),
               Object.fromEntries,
               pairs,
