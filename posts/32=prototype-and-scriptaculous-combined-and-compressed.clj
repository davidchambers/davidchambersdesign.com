(import* ["../src/elements.clj" "../src/components.clj"] {
  ...
  :body [
    ...
    (ul
       [(li
           [(a "http://static.davidchambersdesign.com/scripts/prototype+scriptaculous.js?p=1.6.1&s=1.8.3"
               "prototype+scriptaculous.js")])
        (li
           [(a "http://static.davidchambersdesign.com/scripts/prototype+scriptaculous.min.js?p=1.6.1&s=1.8.3"
               "prototype+scriptaculous.min.js")])
        (li
           [(a "http://static.davidchambersdesign.com/scripts/prototype+scriptaculous.min.js.gz?p=1.6.1&s=1.8.3"
