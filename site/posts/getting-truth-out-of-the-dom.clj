...
(let [
  ...
  :body [
    ...
    (p
       ["Recording of Yehuda Katz's presentation from Bay Area
         jQuery Conf 2011."])

    (p
       [(a "http://vimeo.com/22687694" "Getting truth out of the DOM")])

    (p
       ["While watching this it " (em "finally") " became clear to me why
