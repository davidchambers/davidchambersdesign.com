...
const body = [
  ...
  captioned$002Dimage('/images/posts/63/gmail-icons.png')('Browser tabs featuring different Gmail icons')('Scaled down 32x32 icon (left) and regular favicon'),
  ...
  captioned$002Dimage('/images/posts/63/gmail-icon-32*10.png')('32x32 Gmail icon at 1000%')('32x32 Gmail icon at 1000%'),
  p([
