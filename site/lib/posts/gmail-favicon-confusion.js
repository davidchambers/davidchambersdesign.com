...
const body = [p(["Gmail currently serves up two possible favicons, a 16x16 ", code(["shortcut icon"]), " and a 32x32 ", code(["icon"]), ". ", "I've no idea why the latter is included, but my browser ", "is happy to accept either version, which can lead to a ", "rather amusing situation."]), captioned$002Dimages([{
...
}]), p(["Most days when Gmail loads I get the favicon, but I've had a couple ", "of extended periods of seeing the other version instead. I'd even ", "wondered whether Google was undertaking some A/B testing, although ", "this seemed rather far-fetched. I now believe that there's a race ", "condition, and that the smaller image usually wins this race."]), p(["I far prefer the 32x32 version (it makes the favicon look anaemic), ", "but when I had a close look at it I was upset by its sloppiness."]), captioned$002Dimages([{
