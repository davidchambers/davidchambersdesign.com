...
const excerpt = [
  p([
    ...
    a({ href: 'http://www.sitepoint.com/blogs/2009/08/22/podcast-24-those-frames-are-ironic/' })(['SitePoint Podcast #24']),
    '\n    which discussed the near closure of ',
    a({ href: 'http://tr.im/' })(['tr.im']),
    '.'
  ]),
  p([
    strong([
...
const body = [
  ...
  p([
    ...
    a({ href: 'http://daringfireball.net/' })(['Daring Fireball']),
    '\n    now has its own ',
    a({ href: 'http://sites.google.com/a/snaplog.com/wiki/short_url' })(['shorturl']),
    's, using the incredibly cool domain name \u272Adf.ws.\n    This got me thinking that perhaps I should procure a short domain\n    name and do something similar. Well, last week I did.'
  ]),
  p([
