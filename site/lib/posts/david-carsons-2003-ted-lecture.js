...
})(["Design, discovery and humor"]), " and certainly delivers the ", "entertainment it promises. It's well worth a look."]), dl([dt([object({
...
})])]), dd([p(["David Carson presents ", strong(["Design, discovery and humor"]), " ", "at TED, February 2003"])])])];
export default {
  id: 6,
