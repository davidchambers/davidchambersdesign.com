...
const excerpt = [p(["WordPress is a great piece of software, although I've never been ", "satisfied with its search functionality. Last night I decided to ", "switch to a very simple solution:"]), code$002Dblock("html")("<form action=\"http://www.google.com/search\" method=\"get\">\n    <div>\n        <label for=\"q\">Search davidchambersdesign.com</label>\n        <input type=\"search\" name=\"q\" id=\"q\" maxlength=\"256\" placeholder=\"search...\" />\n        <input type=\"hidden\" name=\"ie\" value=\"UTF-8\" />\n        <input type=\"hidden\" name=\"hl\" value=\"en\" />\n        <input type=\"hidden\" name=\"as_sitesearch\" value=\"davidchambersdesign.com\" />\n        <input type=\"submit\" value=\"Search\" />\n    </div>\n</form>\n  ")];
const body = [...excerpt, p(["Search queries on this site are now submitted to Google with the ", "specification that only results from this domain are to be returned. ", "Here's a breakdown of the various query parameters I included:"]), dl([dt$0027({
  class: "textual"
