...
})(["Camino's FAQ"]), ". I have reproduced its step-by-step instructions ", "below, since they are right on the money."]), ul([li(["First, quit «application»; if it is running."]), li(["Open ", strong(["System Preferences"]), "."]), li(["Choose the ", strong(["\"Keyboard & Mouse\""]), " pane."]), li(["Select the \"Keyboard Shortcuts\" tab."]), li(["Press the \"+\" button at the bottom of that tab."]), li(["In the ", strong(["Application"]), " pop-up menu, choose ", strong(["<application>"]), "."]), li(["In the \"Menu Title\" field, type the exact name of the menu ", "item you want to change, and in the \"Keyboard Shortcut\" field, ", "type the new shortcut you want that menu item to have. Press ", "the \"OK\" button to save the new shortcut."]), li(["You may now relaunch <application>."])])];
export default {
  id: 9,
