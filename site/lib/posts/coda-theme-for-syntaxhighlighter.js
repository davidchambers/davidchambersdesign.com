...
const body = [
  ...
  _h4$0027({ [Symbol.for('id')]: 'css-inside-html' })('CSS inside HTML'),
  p([
  ...
  _h4$0027({ [Symbol.for('id')]: 'javascript-inside-html' })('JavaScript inside HTML'),
  p([
  ...
  _h4$0027({ [Symbol.for('id')]: 'php-inside-html' })('PHP inside HTML'),
  p([
