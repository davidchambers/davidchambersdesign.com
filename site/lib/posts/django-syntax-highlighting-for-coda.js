...
})(["Coda"]), ". ", "It's just so... sexy, somehow. I've just discovered ", a({
  href: "http://www.djangoproject.com/"
})(["Django"]), ", with which ", "I'm fast falling in love as well. Naturally, when I came to write ", "my first Django template I opened Coda.app and started coding."]), p(["It soon became apparent, however, that ", strong(["Coda does not apply ", "syntax highlighting to Django"]), ". The solution? Juan Pablo Claude's ", a({
...
}]), update(datetime("2010-11-14 14:00:00 (Australia/Sydney)"))([p(["I've since discovered an alternative mode which ", "is actively maintained over on GitHub. I now use ", a({
