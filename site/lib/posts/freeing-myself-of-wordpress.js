...
const excerpt = [
  ...
  p([
    'So, ',
    a({ href: 'http://bitbucket.org/davidchambers/mango' })(['Mango']),
...
const body = [
  ...
  ul([
    ...
    li([p([
        a({ href: 'http://wordpress.org/extend/plugins/wp-super-cache/' })(['WP Super Cache']),
    ...
    li([p([
        a({ href: 'http://wordpress.org/extend/plugins/subscribe-to-comments/' })(['Subscribe to Comments']),
        '.\n        Mango does not currently support this feature, but soon will.\n        Hang tight.'
      ])]),
    li([p([
        a({ href: 'http://wordpress.org/extend/plugins/wp-db-backup/' })(['WP-DB-Backup']),
  ...
  p([
    ...
    a({ href: 'http://wordpress.org/extend/plugins/no-curly-quotes/' })(['No Curly Quotes']),
...
`),
  ...
  p([
    ...
    a({ href: 'http://docs.djangoproject.com/en/dev/topics/templates/' })(['Django\'s template language']),
  ...
  p([
    ...
    a({ href: 'http://www.red-sweater.com/marsedit/' })(['MarsEdit']),
    ',\n    however, indicates that I\'m not the only one who prefers to write\n    posts in a desktop application than in a glorified web form.'
  ]),
  p([
    'Mango does not provide an all-in-one solution. This frees\n    me to use the tools I know and love. I can compose a post in ',
    a({ href: 'http://www.hogbaysoftware.com/products/writeroom' })(['WriteRoom']),
    '\n    and publish it with ',
    a({ href: 'http://panic.com/transmit/' })(['Transmit']),
    '\n    (DockSend is fantastic!) or I can write in ',
    a({ href: 'http://panic.com/coda/' })(['Coda']),
