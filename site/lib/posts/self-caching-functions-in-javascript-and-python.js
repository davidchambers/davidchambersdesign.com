...
const excerpt = [
  ...
  code$002Dblock('javascript')(`function fibonacci(n) {
    if (n <= 1) return n;
...
const body = [
  ...
  code$002Dblock('javascript')(`function timer(func) {
    var i = 10, start;
    while (i--) {
        start = new Date;
...
`),
  ...
  code$002Dblock('TK')(`>>> timer(fibonacci, 35);
...
`),
  ...
  p([
    ...
    ' be accessed by our ',
    code(['fibonacci']),
    ' function. This ensures that our cache cannot be\n    overwritten, accidentally or otherwise.'
  ]),
  code$002Dblock('javascript')(`fibonacci = (function () {
...
`),
  ...
  p([
    'A slightly different approach is to initialize the cache with values\n    for 0 and 1, making the ',
    code(['if (n <= 1)']),
    ' logic unnecessary.\n    Since one of the cached values is now 0, however, the ',
    code(['if (cached)']),
...
`),
  ...
  code$002Dblock('python')(`def fibonacci(n):
    if n <= 1:
        return n
    else:
        return fibonacci(n - 2) + fibonacci(n - 1)
...
`),
  ...
  code$002Dblock('python')(`def fibonacci(n, _cache={}):
    if n <= 1:
        return n
    elif n in _cache:
        return _cache[n]
