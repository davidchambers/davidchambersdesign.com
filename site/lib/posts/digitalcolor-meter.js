...
const body = [
  ...
  blockquote([
    p(['To take your Digital Color Metering to the next level, you can drag the\n      color off of the well on the right (next to the R G B labels) into any\n      standard color picker to bring it over. Sometimes, you can even drop it\n      straight into an object in another app!']),
    p(['Give it a try: sample a color, press cmd-shift-h to hold it, then drag\n      and drop from the swatch an object in Pages or Keynote.'])
  ]),
  p([
    'I\'m going to find this incredibly useful. No more grabbing a portion of\n    the screen, switching to Photoshop, creating a new document, hitting \u2318V,\n    switching to the eyedropper tool, double-clicking the foreground colour\n    swatch to invoke the Color Picker, and ',
    em(['then']),
    ' clicking on the\n    appropriate pixel to find its colour value.'
  ]),
  p(['I don\'t think I\'ll miss this process, somehow, although my flatmate\'ll\n    miss the camera shutter sound that accompanies screen captures on OS X\n    (he really likes it, for some reason).'])
];
export default {
  id: 65,
