...
})(["Getting truth out of the DOM"])]), p(["While watching this it ", em(["finally"]), " became clear to me why ", "storing state in the DOM is a terrible idea for complex applications. ", "The approach comes unstuck as soon as one wishes to display an entity ", "more than once in a view (such as in a list–details split view)."])];
export default {
  id: 87,
