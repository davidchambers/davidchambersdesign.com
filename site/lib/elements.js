...
const _render$002Dblock$002Delement = function _render$002Dblock$002Delement(_tag$002Dname) {
  return attrs => children => indent => level => _$002Dinline => indent['repeat'](level) + '<' + Symbol['keyFor'](_tag$002Dname) + S['foldMap'](String)(sym => ' ' + Symbol['keyFor'](sym) + '="' + escape(S['unwords'](S['map'](S['trim'])(S['lines'](attrs[sym])))) + '"')(Object['getOwnPropertySymbols'](attrs)) + '>\n' + S['foldMap'](String)(child => child[Symbol.for('render')](indent)(level + 1)(false))(children) + indent['repeat'](level) + '</' + Symbol['keyFor'](_tag$002Dname) + '>\n';
};
const _render$002Dinline$002Delement = function _render$002Dinline$002Delement(_tag$002Dname) {
  return attrs => children => indent => level => inline => indent['repeat'](level) + '<' + Symbol['keyFor'](_tag$002Dname) + S['foldMap'](String)(sym => ' ' + Symbol['keyFor'](sym) + '="' + escape(S['unwords'](S['map'](S['trim'])(S['lines'](attrs[sym])))) + '"')(Object['getOwnPropertySymbols'](attrs)) + '>' + S['foldMap'](String)(child => child[Symbol.for('render')](indent)(0)(true))(children) + '</' + Symbol['keyFor'](_tag$002Dname) + '>' + (inline ? '' : '\n');
};
const _render$002Dself$002Dclosing$002Delement = function _render$002Dself$002Dclosing$002Delement(_tag$002Dname) {
  return attrs => indent => level => inline => indent['repeat'](level) + '<' + Symbol['keyFor'](_tag$002Dname) + S['foldMap'](String)(sym => ' ' + Symbol['keyFor'](sym) + '="' + escape(S['unwords'](S['map'](S['trim'])(S['lines'](attrs[sym])))) + '"')(Object['getOwnPropertySymbols'](attrs)) + ' />' + (inline ? '' : '\n');
};
