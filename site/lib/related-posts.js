...
const related$002Dposts = posts => post => (() => {
  ...
  return Prelude._apply("slice")([0, 5])(S.sortBy(this$ => S.Pair(-this$.score)(Math.abs((x => x.milliseconds)(Prelude._apply("diff")([post.datetime])(this$.datetime)))))(S.mapMaybe(this$ => this$.slug === post.slug ? S.Nothing : (() => {
